...
if (reversed == null) { reversed = false; }
	...
	this.hover_over_sport.setTransform(503,586.8,0.36,0.36,0,0,0,155.4,125.2);
	...
	this.sport.setTransform(497.15,587.3,0.36,0.36,0,0,0,140.2,118);
	...
	this.hover_over_rathaus.setTransform(347.4,340.95,0.36,0.36,0,0,0,184.8,209.2);
	...
	this.rathaus.setTransform(345.6,339.45,0.36,0.36,0,0,0,178.1,196.6);
	...
	this.hover_over_privat.setTransform(369.25,614.2,0.36,0.36,0,0,0,346.9,208);
	...
	this.privat.setTransform(371.15,614.5,0.36,0.36,0,0,0,328.1,197.7);
	...
	this.hover_over_parken.setTransform(743.1,591.4,0.36,0.36,0,0,0,243.1,236.2);
	...
	this.parken.setTransform(740.85,597.4,0.36,0.36,0,0,0,233.1,247.1);
	...
	this.hover_over_krankenhaus.setTransform(585.25,665.25,0.36,0.36,0,0,0,237.3,234.6);
	...
	this.krankenhaus.setTransform(585,668.5,0.36,0.36,0,0,0,231.1,243.6);
	...
	this.hover_over_industrie.setTransform(906.4,449.85,0.36,0.36,0,0,0,302.4,271.9);
	...
	this.industrie.setTransform(901.05,445.3,0.36,0.36,0,0,0,279.1,249.6);
	...
	this.hover_over_hotel.setTransform(689.85,312.75,0.36,0.36,0,0,0,181.4,303.1);
	...
	this.hotel.setTransform(689.9,308.7,0.36,0.36,0,0,0,181.6,286.1);
	...
	this.hover_over_cafe.setTransform(1417.25,1299.6,1,1,0,0,0,286.8,146);
	...
	this.cafe.name = "cafe";
	this.cafe.setTransform(504.15,481.5,0.36,0.36,0,0,0,282.5,184.1);
	...
	this.hover_over_buero.name = "hover_over_buero";
	this.hover_over_buero.setTransform(523.4,165.75,0.36,0.36,0,0,0,213.5,460);
	...
	this.buero.setTransform(515.15,172.95,0.36,0.36,0,0,0,252.1,480);
	...
	this.hover_over_agrar.setTransform(198.8,465.8,0.36,0.36,0,0,0,479.8,298.2);
	...
	this.agrar.setTransform(215.65,467.45,0.36,0.36,0,0,0,213.1,282.1);
...
p.nominalBounds = new cjs.Rectangle(540,432,1164.6,1014.2);
// library properties:
lib.properties = {
